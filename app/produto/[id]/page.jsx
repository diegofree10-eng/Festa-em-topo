...
export default function DetalhesProduto() {
  ...
  // Hook para detectar largura da tela e ajustar responsividade
  const [isMobile, setIsMobile] = useState(false);

  useEffect(() => {
    // Detecta se é mobile para ajustar o layout dinamicamente
  ...
  const handleAddCart = () => {
    ...
    const item = {
      ...produto,
      preco: precoFinal,
      variacao: produto.categoria === "Kit Festa" ? variacaoSelecionada : null
    };
  ...
  return (
    <div style={styles.container}>
      ...
      {/* O "content" agora muda de grid para flex-column se for mobile */}
      <div style={{
        ...styles.content,
        ...
        {/* LADO ESQUERDO: FOTO GRANDE + MINIATURAS */}
...
const styles = {
  container: { maxWidth: "1100px", margin: "0 auto", padding: "10px 20px", fontFamily: "'Segoe UI', sans-serif" },
  btnVoltar: { background: "none", border: "none", color: "#94a3b8", cursor: "pointer", marginBottom: "15px", fontSize: "14px", fontWeight: "bold" },
  content: { display: "grid", gap: "40px", alignItems: "start" },
  gallery: { display: "flex", flexDirection: "column" },
  ...
  thumbs: { display: "flex", gap: "10px", marginTop: "12px", justifyContent: "center" },
  ...
  titulo: { fontSize: "26px", color: "#1e293b", fontWeight: "800", lineHeight: "1.2", margin: 0 },
  ...
  scrollDesc: { overflowY: "auto", fontSize: "14px", color: "#475569", lineHeight: "1.4" },
