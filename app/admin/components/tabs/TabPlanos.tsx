...
export default function TabPlanos({ planos, setPlanos, mostrarAviso }: TabPlanosProps) {
  ...
  async function salvarConfiguracoes() {
    try {
      ...
      mostrarAviso("Todas as configurações de planos foram salvas!");
    } catch (error) {
      mostrarAviso("Erro ao salvar configurações.", "erro");
    }
  }
...
const styles: any = {
  ...
  recursosSection: { marginTop: '20px', padding: '15px', background: '#f8fafc', borderRadius: '15px', textAlign: 'left' },
  recursosTitle: { fontSize: '10px', fontWeight: '900', color: '#94a3b8', marginBottom: '10px', letterSpacing: '1px' },
